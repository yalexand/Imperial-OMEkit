...
%-------------------------------------------------------------------------%                
        function close_request_fcn(obj,~,~)            
            ...
            unloadOmero;
            %
            %javarmpath(fullfile(pwd,'FileWriteSPW.jar'));
        end        
%-------------------------------------------------------------------------%
            ...
            if single_file
                ...
                if strfind(whos_Dst,'Project')                
                    ...
                    if strcmp(char(obj.Extension),'tif') 
                        ...
                        PlateSetups1 = parse_WP_format(obj.Src); % should always return [] on error
                        ...
                        if ~isempty(PlateSetups1) % old format - shortcutted for now... 
                           ...
                           contentdir = dir(obj.Src);
                            ...
                            PlateSetups2 = parse_MultiChannel_WP_format(obj.Src); % should always return [] on error
